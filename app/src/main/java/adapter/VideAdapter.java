...
public class VideAdapter extends RecyclerView.Adapter <VideAdapter.HomeViewHolder>{

    private Context mContext;
    private ArrayList<Article> mData;

    View view;
    public VideAdapter(Context mContext, ArrayList<Article> mData) {
    ...
    public HomeViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new VideAdapter.HomeViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull final HomeViewHolder holder, final int position) {
        ...
        holder.rl_one_produit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(mContext, mData.get(position).getName()+"/"+mData.get(position).getQuantite()+"/"+mData.get(position).getDate(), Toast.LENGTH_LONG);
            }
        });
